...
import cl.playground.cv_converter.service.ResumeServiceImpl;
...
class ChatGPTPromptUtilTest {
    ...
    void testExtractResumeContent_Success() throws IOException {
        ...
        String extractedText = ChatGPTPromptUtil.createPrompt(ResumeExtractorUtil.extractResumeContent(multipartFile), language, comments);
